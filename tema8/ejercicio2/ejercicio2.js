...
primerDestino.addEventListener("change",(e)=>{
    ...
    destinos["Destinos"].forEach(destino => {
        ...
        console.log("suelta:"+destino[origenNombreSeleccionado])
        console.log(origenNombreSeleccionado);
        //Introduciendo los destinos dentro de select
        // destino[origenNombreSeleccionado].forEach(destino =>{
        //     let opciones=document.createElement('option');
        //     opciones.innerHTML=destino;
        //     destinoEtiqueta.appendChild(opciones);
