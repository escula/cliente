...
.addEventListener('submit',function (evento) {
    ...
    xhttp.open("GET",'servidor1.php?param='+nombreUsuario,true) //si se pone false no se puede poner antes del onredy ya que la llamada ya nos e realiza asincronamente prodciendo que el onredy nunca se ejecute cuando debe
